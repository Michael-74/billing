...
@Configuration
@EnableWebMvc
@ComponentScan({"ru.soyuz_kom.controller", "ru.soyuz_kom.config", "ru.soyuz_kom.service", "ru.soyuz_kom.service.Impl", "ru.soyuz_kom.listener", "ru.soyuz_kom.entity.listener", "ru.soyuz_kom.provider"})
